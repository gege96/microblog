...
$query=mysql_query("SELECT * FROM say WHERE blog_id = '{$blog_id}' ORDER BY id DESC");
while ($row=mysql_fetch_array($query)) {
	$sayList.=formatSay($row['content'],$row['addtime'],$row['username'],$row['say_id']);
    $say_id = $row['say_id'];
    //echo "dadadada:$say_id<br>";
}
