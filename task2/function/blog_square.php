...
<a href="personal_blog.php">我的微博</a><br>
<a href="blog_release.php">发布新微博</a><br>
...
<div id="main">
    <div class="demo">
        <div id="saywrap">
            ...
            <li>日期：<?php echo $rs['createtime'];?><a href="blog_forward.php?id=<?php echo $rs['blog_id'];?>">|转发|</a>
            <a href="blog_collect.php?id=<?php echo $rs['blog_id'];?>">|收藏|</a></li>
            <p>内容<?php echo iconv_substr($rs['content'],0,50,"UTF-8");?>......
            <a href="blog_content.php?id=<?php echo $rs['blog_id'];?>">|查看详细内容|</a></p>
        </div>
    </div>
</div>
