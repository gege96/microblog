...
if (!empty($_GET['id'])) {
    ...
    //刷新浏览数
    $stmt = $link->prepare('UPDATE blog SET hits = hits + 1 WHERE blog_id =  ?');
    $stmt->bind_param('i', $_GET['id']);
    $stmt->execute();
...
<div id="main">
    <div class="demo">
        <div id="saywrap">
            ...
            <li><?php echo "日期：".$rc['createtime']."|浏览次数：".$rc['hits'];?>|<a href="blog_concern.php?id=<?php echo $rc['blog_id'];?>">关注</a>
